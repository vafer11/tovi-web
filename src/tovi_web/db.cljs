...
(def default-db
  {:name "re-frame"
   ...
   :recipes {1 {:id 1
                :name "Pan Frances"
                :image {:name "Pan Frances" :attachment nil :src nil}
             ...
             2 {:id 2
                :name "Pan de Viena"
                :image {:name "Pan de Viena" :attachment nil :src nil}
                :steps "Integrar bien todos los ingredients despues bla bla bla bla bla bla bla bla bla"
                :ingredients {1 {:id 1 :label "Harina" :percentage 100 :quantity 1000}
             ...
             3 {:id 3
                :name "Bizcochos"
                :image {:name "Bizcochos" :attachment nil :src nil}
                :steps "Integrar bien todos los ingredients despues bla bla bla bla bla bla bla bla bla"
                :ingredients {1 {:id 1 :label "Harina" :percentage 100 :quantity 1000}
