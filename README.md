...
* [`src/tovi_web/`](src/tovi_web/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/tovi_web/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `tovi-web` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tovi_web/config.cljs) defaults to `true` in
...
```clj
(ns tovi-web.example
  (:require [tovi-web.config :as config])
